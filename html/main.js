$('document').ready(function() {
    ...
    function CreateNotification(data) {
        ...
        <div class="content">\
            ...
            <div id="alert-info"><i class="fas fa-user"></i>Sex: '+sex+'</div>\
            <div id="alert-info"><i class="fas fa-keyboard"></i>'+data.info["inVeh"][0]+'</div>\
            '+carcolor+'\
            <div id="alert-info"><i class="fas fa-keyboard"></i>Press [<font style="color: #f88;">M</font>] the button to mark it on the GPS.</div>\
        </div>');
        $notification.fadeIn();
